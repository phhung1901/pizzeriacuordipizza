...
(function($) {
	...
	Calendar.prototype.getEventsBetween = function(start, end) {
	    var events = [];
	    var calendar_name = this.options.calendar_name;
		$.each(this.options.events, function() {
		    //if(this.start == null || event.id.indexOf(self.options.calendar_name) == -1 ) {
		    if (this.id.indexOf(calendar_name) == -1) return false;
		    if(this.start == null ){
				return true;
			}
	...
	function showEventsList(event, that, slider, self) {
		...
		slider.slideUp('fast', function() {
		    ...
		    //var localevents = self.getEventsBetween(parseInt(event_list.data('cal-start')), parseInt(event_list.data('cal-end')));
