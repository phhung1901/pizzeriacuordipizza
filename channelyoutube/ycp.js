...
function youtube_video_list(f, g, h, j, k, l) {
    $.ajax({
        ...
        var d = '';
        d += '<div class="ibacordotcom-vid-top"><span class="ibacordotcom-nav-title">' + j + '</span><br><span class="ibacordotcom-vid-by">by <a href="https://www.youtube.com/channel/' + l + '" target="_BLANK">' + l + '</a></span><hr>';
